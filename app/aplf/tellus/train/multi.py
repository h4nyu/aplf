...
def train_epoch(model,
    ...
    for pos_sample, neg_sample in zip(pos_loader, neg_loader):
        ...
        pred_labels, pred_landsat = model(palsar)
        fusion_loss = class_cri(pred_labels, labels)
        landsat_loss = image_cri(pred_landsat, landsat)
    ...
    return model, {
        "fusion": mean_fusion_loss,
        "landsat": mean_landsat_loss
    }
