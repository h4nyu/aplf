...
class UNet(nn.Module):
    def __init__(self, in_ch=1):
        ...
        self.conv0 = nn.Conv2d(in_ch, 16, kernel_size=3)
        ...
        self.conv2_0 = nn.Conv2d(64, 64, kernel_size=3)

        self.center0 = nn.Conv2d(64, 128, kernel_size=3)
        self.center1 = nn.ConvTranspose2d(128, 64, 2, stride=2)

        self.deconv2_0 = nn.Conv2d(128, 64, kernel_size=3)
        self.deconv2_1 = nn.Conv2d(64, 64, kernel_size=3)
        ...
        self.deconv0_1 = nn.Conv2d(16, 16, kernel_size=3)
    ...
    def forward(self, input, segment=None):
        ...
        x = F.interpolate(x, size=conv2.size()[2:])
